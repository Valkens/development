...
CREATE TABLE `purchase` (
  ...
  `totalcharge` double(10,2) unsigned NOT NULL,
  `creholder` varchar(60) NOT NULL,
  `cardnumber` int(30) unsigned NOT NULL,
  `expiredate` varchar(6) NOT NULL,
  `securedcode` char(4) NOT NULL,
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
insert  into `purchase`(`userid`,`dealid`,`quantity`,`totalcharge`,`creholder`,`cardnumber`,`expiredate`,`securedcode`,`id`,`createtime`) values (1,3,2,120.00,'admin',11111,'14/4','1111',3,'2012-12-25 09:30:12'),(1,3,2,120.00,'admin',11111,'14/4','1111',4,'2012-12-25 09:30:12'),(1,3,2,120.00,'admin',11111,'14/4','1111',5,'2012-12-25 09:30:12'),(1,2,2,600.00,'admin',111,'15/6','1212',6,'2012-12-25 09:30:12');
