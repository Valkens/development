        ...
        <div id="tab-general">
          <table class="form">
            <tr>
              ...
              <td><input type="text" id="manufacturer_name" name="name" value="<?php echo $name; ?>" size="100" />
                <?php if ($error_name) { ?>
            ...
            <tr>
              ...
              <td><input type="text" id="manufacturer_slug" name="keyword" value="<?php echo $keyword; ?>" /></td>
            </tr>
            <tr>
