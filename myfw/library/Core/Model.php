...
class Core_Model
{
    ...
    protected static function _get_table_name($class_name) {
        ...
        if (is_null($specified_table_name)) {
            return self::$auto_prefix_models . self::_class_name_to_table_name($class_name);
        }
    ...
    public static function factory($class_name, $connection_name = null) {
        ...
        if ($connection_name == null) {
            $connection_name = self::_get_static_property(
                $class_name,
                '_connection_name',
                Core_Orm_Wrapper::DEFAULT_CONNECTION
            );
        }
        $wrapper = Core_Orm_Wrapper::for_table($table_name, $connection_name);
