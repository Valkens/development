...
$this->headLink()
        ...
        ->prependStylesheet($this->baseUrl().'/application/css.php?request=application/modules/Blog/widgets/new-blogs/styles.css');
?> 
<ul>
   ...
   <tr><td>
      ...
      <span>
           <?php echo $this->translate('There is not new blog.');?>
      </span>
