<?php
$this->headLink()
        ->prependStylesheet($this->baseUrl().'/application/css.php?request=application/modules/Blog/widgets/tags-blogs/styles.css');
...
<span id="script" style="font-size: 9pt;">
             ...
             </span><span id="hide" style="display:none;style="font-size: 8pt;"">
             <?php  endif;?>
