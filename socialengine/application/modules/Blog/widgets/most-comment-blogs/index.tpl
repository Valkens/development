...
$this->headLink()
        ->prependStylesheet($this->baseUrl().'/application/css.php?request=application/modules/Blog/externals/styles/main.css')
         ->prependStylesheet($this->baseUrl().'/application/css.php?request=application/modules/Blog/widgets/most-comment-blogs/styles.css'); 
?> 
   <ul>
   <div><div>
                <div class="vertmenu"> 
   ...
   <?php if(count($this->blogs) <= 0): ?>   
      ...
      <span>
           <?php echo $this->translate('There is not commented blog.');?>
      </span>
 ...
 <?php else: $i = 0;?>
        ...
        <?php echo $this->timestamp($blog->creation_date) ?>  <?php //echo $blog->comment_count; ?>
                    </div>
         ...
         <?php if($i%2 == 1 && $i < count($this->blogs) - 1): echo '</tr><tr><td class="b" style="height:1px; "></td><td class="b" style="height:1px;"></td></tr> <tr>'; endif;?>
