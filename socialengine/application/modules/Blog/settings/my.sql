...
ALTER TABLE engine4_blog_becomes ADD CONSTRAINT blog_user UNIQUE (blog_id, user_id);
...
('blog_main_browse', 'blog', 'Browse Entries', '', '{"route":"blog_general"}', 'blog_main', '', 1),
...
('blog_admin_main_categories', 'blog', 'Categories', '', '{"route":"admin_default","module":"blog","controller":"settings", "action":"categories"}', 'blog_admin_main', '', 5),
