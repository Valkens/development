 ...
 * @version    $Id: Delete.tpl SE-1488 duclh $
 * @author     duclh
 */
?>
...
<div class="global_form">
  ...
  <form method="post">
    <div>
      <h3><?php echo $this->translate("Delete the selected books?") ?></h3>
      <p>
        <?php echo $this->translate("Are you sure that you want to delete the %d books? It will not be recoverable after being deleted.", $this->count) ?>
      </p>
      <br />
      <p>
  ...
  <?php else: ?>
    <?php echo $this->translate("Please select a book to delete.") ?> <br/><br/>
